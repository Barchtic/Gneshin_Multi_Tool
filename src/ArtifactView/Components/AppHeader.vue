...
<template>
    <header>
        <div class="icon"></div>
        <div class="title">{{ __('Artifacts') }} - {{ __(` ${auto ? ' Enable' : ' Disable'}`) }}</div>
        <div class="actions">
            ...
            <el-tooltip
                class="item"
                effect="light"
                :content="__('Turn On The Auto Switcher')"
                placement="bottom"
            ...
            <template v-if="status > STATUS.INTRO">
                ...
                <el-tooltip
                    class="item"
                    effect="light"
                    :content="__(`${auto ? 'Close' : 'Open'}Click to Recognize`)"
                    placement="bottom"
                    popper-class="titlebar-tip"
                    transition="none"
                    :enterable="false"
