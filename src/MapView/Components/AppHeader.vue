        ...
        async openSync() {
            try {
                await ElMessageBox.confirm(
                    'Map Synchronizer is an experimental feature under testing and is currently in an extremely unstable state, so please use it with caution.',
